...
INSERT INTO item (item, description, image) VALUES ('AK-47', 'Broń jest niezwykle trwała, niezawodna i odporna na zabrudzenia oraz zaniedbania eksploatacyjne. Jest też prosta w obsłudze i tania w produkcji, przez co idealnie nadaje się do masowej produkcji i wykorzystywania nawet przez słabo wyszkolone oddziały. Do wad zalicza się dość słabą ergonomię i niewielką celność na dystansach ponad 300 metrów. Wziąwszy jednak pod uwagę, że w 85% przypadków z broni tego typu strzela się na odległości poniżej 300 metrów, wada ta nie ma większego znaczenia. Nie licząc produkcji licencyjnej, z konstrukcji karabinka AK bezpośrednio lub pośrednio wywodzą się takie bronie jak fińskie karabiny rodziny Valmet M62 i Sako M95, izraelskie Galile i polskie Beryle.', '/images/AK-47.jpg')
...
Cywilne zastosowanie noktowizorów to wyposażenie dla myśliwych, wspomaganie nocnego monitoringu w budynkach oraz realizacja filmów przyrodniczych w warunkach nocnych, bez płoszenia zwierząt sztucznym oświetleniem. Podobne zastosowanie posiada celownik noktowizyjny.', '/images/NVD.jpg')
, ('Dron', 'Urządzenia tego rodzaju, bez żadnego wyposażenia, już od czasów I wojny światowej stosowane były do trenowania oddziałów przeciwlotniczych jako latające cele. Latające bomby V-1 stosowane przez Niemców do bombardowania Londynu czy też pociski manewrujące też zaliczane mogłyby być do kategorii UAV, niemniej pojazdy tego typu są bronią samą w sobie i nie mogą być – w odróżnieniu od BSP – powtórnie wykorzystane.', '/images/Drone.jpg')
, ('M4', 'Początkowo M4 był używany przez żołnierzy jednostek specjalnych, z czasem stał się popularną bronią także w jednostkach zwykłej piechoty, jako uzbrojenie młodszych oficerów, obsług broni ciężkiej i coraz częściej szeregowych żołnierzy. M4 stał się także następcą pistoletów maszynowych M3 używanych przez załogi czołgów i pojazdów opancerzonych.', '/images/M4.jpg')
, ('Spadochron', 'Statek powietrzny, który wykorzystując opór powietrza do zmniejszenia prędkości opadania w atmosferze, pozwala na bezpieczne wylądowanie podwieszonego skoczka, sprzętu lub ładunku.', '/images/Parachute.jpg')
, ('C4', 'Rodzaj plastycznego materiału wybuchowego. Składa się z właściwego materiału wybuchowego, spoiwa, masy plastycznej i (w ostatnich czasach) substancji znakujących. Materiałem wybuchowym w C4 jest heksogen (heksahydro-1,3,5-trinitro-1,3,5-triazyna), który stanowi ponad 90% masy C4. Spoiwem jest poliizobutylen (ok. 2%), a plastyfikatorem jest sebacynian di(2-etyloheksylu) (ok. 5%). Dodaje się również niewielkie ilości (ok. 1,5%) oleju silnikowego. Czasem jako spoiwo stosowany jest adypinian dioktylu (DOA). W USA substancją znakującą jest DMDNB (2,3-dimetylo-2,3-dinitrobutan).', '/images/C4.jpg')
, ('USP' ,'HK USP jest bronią samopowtarzalną. Zasada działania oparta o krótki odrzut lufy. Mechanizm spustowy z kurkowym mechanizmem uderzeniowym. Pistolet może być wyposażony w bezpiecznik nastawny i zwalniacz kurka. USP jest zasilany z wymiennego, dwurzędowego magazynka pudełkowego o pojemności zależnej od rodzaju naboju. Zatrzask magazynka po obu stronach chwytu pistoletowego. Po wystrzeleniu ostatniego naboju z magazynka zamek zatrzymuje się w tylnym położeniu.', '/images/USP.jpg')
, ('M82A1', 'W roku 2012 zanotowano najdalsze potwierdzone trafienie z karabinu M82A1 wynoszące 2815 metrów. Strzał oddał stacjonujący w Afganistanie (prowincja Helmand) australijski zespół snajperski z kompanii Delta 2. pułku Commando (2 Cdo Regt) podczas działań obserwacyjnych dostrzegł oddział talibów. Jedna z wystrzelonych kul trafiła dowódcę oddziału talibów. Jest to drugi z najdalszych oddanych do tej pory skutecznych strzałów (najdalszy padł z karabinu McMillan TAC-50). Nazwisko strzelca pozostaje nieznane.', '/images/M82A1.jpg');
